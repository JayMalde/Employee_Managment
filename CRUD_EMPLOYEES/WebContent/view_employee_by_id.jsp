...
<title>Displaying Employee By Id</title>
</head>
<body>
<% 
...
<form action='update_employee.jsp' method='post'>
	<table align="center" border="1">
		<tr><th align="center" bgcolor="indigo" style="color:white" colspan="2"><h1>Showing Employee By ID <%=emp.getEmp_id()%></h1></th></tr>
		<tr><td>Employee ID</td><td><input type='text' name='id' value='<%=emp.getEmp_id()%>'/></td></tr>
