...
<%@page import="com.employees.crud.EmployeeDAO, com.employees.crud.Employees, com.employees.crud.DepartmentDAO, com.employees.crud.Department, java.util.*"%>  
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>   
<%  
int id = Integer.parseInt(request.getParameter("id"));  
List<Employees> list = EmployeeDAO.getEmployeeByDepartment(id); 
...
<tr><th align="center" bgcolor="indigo" style="color:white" colspan="15"><h1>Employee List By Department</h1></th></tr>
<tr>
	<th>Emp Id</th>
	<th>First Name</th>
	<th>Middle Name</th>
